    ...
    <div className="grid gap-2 sm:grid-cols-2">
      {leagues.map((league) => (
        ...
        >
          ...
          <p className="text-xs text-neutral-500">Código: {league.code}</p>
          <p className="mt-2 text-xs font-semibold text-emerald-700 dark:text-emerald-300">Abrir clasificación de esta liga</p>
        </button>
      ))}
    </div>
  );
